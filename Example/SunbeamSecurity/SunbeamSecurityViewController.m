...
- (void)viewDidLoad
{
    ...
    //NSString* jsonString = @"1234567890";
    ...
    NSString* encryptString = [SunbeamSecurityService encryptJsonObject:array key:key iv:key];
    id jsonObject = [SunbeamSecurityService decryptJsonObject:encryptString key:key iv:key];
    NSLog(@"最终jsonObject为：%@", jsonObject);
}
